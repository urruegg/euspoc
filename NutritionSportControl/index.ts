...
export class NutritionSportControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    public init(
        ...
        this._counsellingData = context.parameters.sampleProperty.raw || "";
    ...
    private renderControl(context: ComponentFramework.Context<IInputs>): void {
        const clientName = context.parameters.sampleProperty.raw || undefined;

        this._root.render(
            React.createElement(NutritionSportApp, {
    ...
    public getOutputs(): IOutputs {
        return {
            sampleProperty: this._counsellingData
        };
    }
